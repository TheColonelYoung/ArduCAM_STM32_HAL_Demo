...
const vector<SPI_camera::Register_blob_16> ov5642_320x240  =
{
...
const vector<SPI_camera::Register_blob_16> ov5642_640x480  =
{
	{0x3800 ,0x1 },
	{0x3801 ,0xa8},
	{0x3802 ,0x0 },
...
const vector<SPI_camera::Register_blob_16> ov5642_1280x960  =
{
	{0x3800 ,0x1 },
	{0x3801 ,0xB0},
	{0x3802 ,0x0 },
...
const vector<SPI_camera::Register_blob_16> ov5642_1600x1200  =
{
	{0x3800 ,0x1 },
	{0x3801 ,0xB0},
	{0x3802 ,0x0 },
...
const vector<SPI_camera::Register_blob_16> ov5642_1024x768  =
{
	{0x3800 ,0x1 },
	{0x3801 ,0xB0},
	{0x3802 ,0x0 },
...
const vector<SPI_camera::Register_blob_16> ov5642_2048x1536  =
{
	{0x3800 ,0x01},
	{0x3801 ,0xb0},
	{0x3802 ,0x00},
...
const vector<SPI_camera::Register_blob_16> ov5642_2592x1944  =
{
	{0x3800 ,0x1 },
	{0x3801 ,0xB0},
	{0x3802 ,0x0 },
...
const vector<SPI_camera::Register_blob_16> ov5642_dvp_zoom8 =
{
...
const vector<SPI_camera::Register_blob_16> OV5642_QVGA_Preview  =
{
	{0x3103 ,0x93},
	{0x3008 ,0x82},
	{0x3017 ,0x7f},
...
const vector<SPI_camera::Register_blob_16> OV5642_JPEG_Capture_QSXGA  =
{
...
const vector<SPI_camera::Register_blob_16> OV5642_1080P_Video_setting  =
{
	{0x3103 ,0x93},
	{0x3008 ,0x82},
	{0x3017 ,0x7f},
...
const vector<SPI_camera::Register_blob_16> OV5642_720P_Video_setting  =
{
	{0x3103 ,0x93},
	{0x3008 ,0x82},
	{0x3017 ,0x7f},
