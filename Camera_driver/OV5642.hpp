 ...
 */
class OV5642: protected SPI_camera
{
private:
    /**
...
public:
     ...
     */
    OV5642(I2C_HandleTypeDef I2C_handle, SPI_HandleTypeDef SPI_handle, Chip_select_pin SPI_CS):
        SPI_camera(I2C_handle, 0x78, SPI_handle, SPI_CS) {};
     ...
     */
    void Init(const vector<Register_blob_16> &regs);

    /**
     * @brief Initializes capture of image, waits for capture, transmit image into MCU memory
     */
    void Capture(uint capture_delay) override final;
